...
function VerloopVoorkomen() {
  return (
    <>
      <SEOHead 
        title="Voorkom Personeelsverloop - Inzicht in team-dynamiek"
        description="Hoge werkdruk of onvrede? Zie direct welk team op omvallen staat. 100% anoniem, dus 100% eerlijke antwoorden. Voorkom verzuim en verloop."
        keywords="personeelsverloop voorkomen, verloop voorkomen, verzuim voorkomen, team dynamiek, werkdruk signaleren, personeelsbehoud, HR software"
        canonical="https://groeirichting.nl/verloop-voorkomen"
        structuredData={{
          "@context": "https://schema.org",
          "@type": "SoftwareApplication",
          "name": "GroeiRichting - Verloop Voorkomen",
          ...
          "description": "Zie direct in welk team de uitstroom dreigt. Krijg real-time signalen over werkdruk en sfeer per afdeling. Voorkom verzuim en verloop.",
          "keywords": "personeelsverloop voorkomen, verloop voorkomen, verzuim voorkomen, team dynamiek",
          "url": "https://groeirichting.nl/verloop-voorkomen"
        }}
      />
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center pt-24 px-6 max-w-7xl mx-auto">
          <div className="order-2 md:order-1">
            ...
            <p className="text-sm text-[var(--kleur-muted)] italic">
              Veilig & Anoniem voor medewerkers. Inzicht voor jou.
            </p>
          </div>
        ...
        <section className="py-12 px-6">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-[var(--kleur-primary)] mb-12 text-center">
              Waarom exit-gesprekken te laat zijn
            </h2>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg border-2 border-red-100">
                ...
                <ul className="space-y-4 text-[var(--kleur-muted)]">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Je hoort pas wat er speelt als iemand vertrekt</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <X className="w-5 h-5 text-red-600 mt-0.5 flex-shrink-0" />
                    <span>Politiek correcte antwoorden (niet eerlijk)</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <X className="w-5 h-5 text-red-600 mt-0.5 flex-shrink-0" />
                    <span>Hoge kosten door werving</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg border-2 border-[var(--kleur-accent)]">
                ...
                <ul className="space-y-4 text-[var(--kleur-muted)]">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Zie live welk team onder druk staat</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-[var(--kleur-accent)] mt-0.5 flex-shrink-0" />
                    <span>Anoniem, dus medewerkers durven eerlijk te zijn</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-[var(--kleur-accent)] mt-0.5 flex-shrink-0" />
                    <span>Behoud je beste mensen pro-actief</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              <h3 className="text-xl font-semibold text-[var(--kleur-primary)] mb-2">
                Waarom zie ik resultaten per team en niet per persoon?
              </h3>
              <p className="text-[var(--kleur-muted)]">
                Omdat psychologische veiligheid heilig is. Als medewerkers weten dat het anoniem is (per team), geven ze eerlijke antwoorden. Zo krijg jij data waar je écht op kunt sturen, zonder 'Big Brother' te spelen.
              </p>
            </div>
...
export default VerloopVoorkomen
