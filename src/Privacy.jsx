      ...
      <div className="max-w-4xl mx-auto py-8 px-6">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4">
              <div className="bg-white p-4 rounded-lg border-l-4 border-[var(--kleur-primary)]">
                ...
                <p className="text-[var(--kleur-text)]">verwerkingsverantwoordelijke voor de persoonsgegevens van werknemers die via het GroeiPortaal worden verwerkt.</p>
              </div>
              <div className="bg-white p-4 rounded-lg border-l-4 border-[var(--kleur-accent)]">
                <h3 className="font-semibold text-[var(--kleur-accent)] mb-2">GroeiRichting B.V.</h3>
                <p className="text-[var(--kleur-text)]">verwerker die deze verwerking uitvoert namens de werkgever, conform de verwerkersovereenkomst die onderdeel uitmaakt van de samenwerking.</p>
              </div>
            </div>
          ...
          <section className="mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <h3 className="text-lg font-semibold text-[var(--kleur-primary)] mb-4">4.1 Werkgevers</h3>
                <p className="text-[var(--kleur-text)] mb-3">Voor het aanmaken en beheren van accounts:</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <h3 className="text-lg font-semibold text-[var(--kleur-primary)] mb-4">4.2 Werknemers</h3>
                <p className="text-[var(--kleur-text)] mb-3">Voor het gebruik van het portaal:</p>
                <ul className="list-disc pl-6 space-y-1 text-[var(--kleur-text)]">
          ...
          <section className="mb-8">
            ...
            <div className="bg-[var(--kleur-accent)] bg-opacity-10 p-4 rounded-lg">
          ...
          <section className="mb-8">
            ...
            <p className="text-[var(--kleur-text)] mt-4 font-medium">
          ...
          <section className="mb-8">
            ...
            <p className="text-[var(--kleur-text)] mt-2">
